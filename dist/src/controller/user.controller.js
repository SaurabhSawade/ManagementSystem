...
const userController = {
    createUser: (0, asyncHandler_1.default)(async (req, res) => {
        ...
        return res.status(httpStatus_1.HTTP_STATUS.CREATED).json(apiResponse_1.default.buildResponse({
    ...
    blockUser: (0, asyncHandler_1.default)(async (req, res) => {
    ...
    unblockUser: (0, asyncHandler_1.default)(async (req, res) => {
    ...
    forceResetPassword: (0, asyncHandler_1.default)(async (req, res) => {
    ...
    grantAdmin: (0, asyncHandler_1.default)(async (req, res) => {
    ...
    revokeAdmin: (0, asyncHandler_1.default)(async (req, res) => {
